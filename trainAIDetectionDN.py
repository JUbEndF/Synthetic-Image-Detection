...
from sklearn.metrics import cohen_kappa_score, auc, confusion_matrix, roc_auc_score, roc_curve
from tqdm import tqdm
from scripts.ArgumentParser import ArgumentParser
from networks.ClassifierBasedNoiseSignal.ClassifierNoiseExtraction import NoiseExtractionClassifier, NoiseExtractionClassifier3LBatchNorm1d
...
if __name__ == '__main__':
    ...
    model = NoiseExtractionClassifier3LBatchNorm1d(in_channels=3, num_classes=2).to(args.device)  # Предполагаем, что два класса (например, настоящие и фальшивые изображения)
    ...
    for epoch in range(args.epochs):
        ...
        kappa = cohen_kappa_score(train_labels, train_predictions)
        print("kappa: ", kappa)
