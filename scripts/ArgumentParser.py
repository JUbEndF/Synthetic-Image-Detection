...
class ArgumentParser:
    ...
    def add_arguments(self):
        ...
        self.parser.add_argument('--epochs', type=int, default=2, help='Number of training epochs')
        self.parser.add_argument('--train_data_path', type=str, default='./data/humanDataset/train', help='Path to training data')
        self.parser.add_argument('--val_data_path', type=str, default='./data/humanDataset/val', help='Path to validation data')
        self.parser.add_argument('--test_data_path', type=str, default='./data/humanDataset/val', help='Path to test data')
